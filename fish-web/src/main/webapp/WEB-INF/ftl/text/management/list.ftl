        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/text/management/list">列表展示</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/text/management/list">
                        <div class="col-sm-3" style="padding-right: 0px;padding-left: 0px;">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key"  placeholder="输入标题" />
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="text:management:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>

				<@shiro.hasPermission name="text:management:delete">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    ...
                                    <span style="background-color: #1945de;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">公告</span>
                                    {{# }else if(d[i].classification==3){ }}
                                    <span style="background-color: #1AA094;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">市场</span>
                                    {{# }else if(d[i].classification==4){ }}
                                    <span style="background-color: #EF5352;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">政策</span>
                                    {{# }else if(d[i].classification==5){ }}
                                    <span style="background-color: #00bbee;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">技术</span>
                                    {{# }else { }}
                                    <span style="background-color: #0C0C0C;color: #ffffff;border-radius: 5px;font-size: 20px;padding: 5px; ">管理</span>
                                    {{# } }}
                                </td>
                                <td>{{d[i].title}}</td>

                                <td>
								<@shiro.hasPermission name="text:management:edit">
                                    <a href="${basePath}/text/management/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/text/management/list",
    ...
    function add(){
        window.location.href="${basePath}/text/management/add";

    }
    function edit(id){
        window.location.href="${basePath}/text/management/edit/"+id;
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/text/management/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
