...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/text/management/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/text/management/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox i-checks">
                                                    <label>
                                                        <input type="radio" name="classification" value="1"> <i></i>通知</label>
                                                    <label>
                                                        <input type="radio" name="classification" value="2"> <i></i>公告</label>
                                                    <label>
                                                        <input type="radio" name="classification" value="3"> <i></i>市场</label>
                                                    <label>
                                                        <input type="radio" name="classification" value="4"> <i></i>政策</label>
                                                    <label>
                                                        <input type="radio" name="classification" value="5"> <i></i>技术</label>
                                                    <label>
                                                        <input type="radio" name="classification" value="6"> <i></i>管理</label>
                                                </div>
                                            </div>
                                        </div>
