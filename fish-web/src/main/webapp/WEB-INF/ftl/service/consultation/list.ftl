        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/service/consultation/list">咨询服务列表</a></li>
                </ul>
            </div>
        </div>
	    <div class="ibox-content" style="border-color: transparent">
	        ...
	        <div class="row">
	            <div class="col-sm-12">  
	                ...
	                <form name="admin_list_sea" class="form-search" method="get" action="${basePath}/service/consultation/list">
		            ...
		            <table class="table table-bordered table-hover">
		                ...
		                {{# for(var i=0;i<d.length;i++){  }}
							<tr class="long-td">
                                ...
                                <td>
                                    <img src="{{d[i].img}}" class="img-circle" style="width:30px;height:30px" onerror="this.src='${basePath}/static/webupload/head_default.gif'"/>
                                </td>
                                <td>{{d[i].describe}}</td>
                                <td>
                                 <@shiro.hasPermission name="service:consultation:delete">
...
<div class="spiner-example">
	...
	function Ajaxpage(curr){
		$.ajax({
			url: "${basePath}/service/consultation/list",
    ...
    function del(id){
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            $.ajax({
                url: "${basePath}/service/consultation/delete",
                data:"id="+id,
                type: "POST",
                dataType:'json',
