        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/rotation/chart/add" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">名称：</label>
                            <div class="col-sm-3">
                                <input id="title" type="text" class="form-control" name="name" required="" placeholder="请输入名称" aria-required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks">
                                    <label>
                                        <input type="radio" checked=checked value="1" name="type"> <i></i>通知</label>
                                    <label>
                                        <input type="radio"  value="2" name="type"> <i></i>公告</label>
                                    <label>
                                        <input type="radio"  value="3" name="type"> <i></i>市场</label>
                                    <label>
                                        <input type="radio"  value="4" name="type"> <i></i>政策</label>
                                    <label>
                                        <input type="radio"  value="5" name="type"> <i></i>技术</label>
                                    <label>
                                        <input type="radio"  value="6" name="type"> <i></i>管理</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="linkId" type="text" value="0" class="form-control" name="linkId" required="" aria-required="true">请输入工匠资讯id
                            </div>
                        </div>
