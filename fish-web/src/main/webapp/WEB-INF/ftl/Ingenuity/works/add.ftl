...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/ingenuity/works/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/ingenuity/works/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="projectName" type="text" class="form-control" name="projectName" required="" placeholder="请输入项目名称" aria-required="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="location" type="text" class="form-control" name="location" required="" placeholder="请输入项目建设地点" aria-required="true"><span class="help-block m-b-none">长度不应超过30个字符</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">竣工时间：</label>
                                            <div class="col-sm-3">
                                                <input id="completionTime" type="text" class="form-control" name="completionTime" required="" placeholder="请输入竣工时间" aria-required="true"><span class="help-block m-b-none">竣工时间请按此格式填写, 如: 2019-11 或 2019-07</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">工程造价：</label>
                                            <div class="col-sm-3">
                                                <input id="engineeringCost" type="text" class="form-control" name="engineeringCost" required="" placeholder="请输入工程造价" aria-required="true"><span class="help-block m-b-none">项目造价请按此格式填写，如:2000万元</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio" checked=checked value="1" name="type"> <i></i>酒店/办公</label>
                                                    <label>
                                                        <input type="radio"  value="2" name="type"> <i></i>学校/医院</label>
                                                    <label>
                                                        <input type="radio"  value="3" name="type"> <i></i>商贸/住宅</label>
                                                    <label>
                                                        <input type="radio"  value="4" name="type"> <i></i>展览/展示</label>
                                                    <label>
                                                        <input type="radio"  value="5" name="type"> <i></i>幕墙/机电</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
