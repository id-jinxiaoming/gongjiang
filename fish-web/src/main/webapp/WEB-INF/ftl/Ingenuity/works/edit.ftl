...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/ingenuity/works/edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/ingenuity/works/edit">编辑</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ibox-content" style="border:none;">
                            ...
                            <div class="layui-tab-content" style="height: 100%;">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input id="projectName" value="${ingenuityWorks.projectName}" type="text" class="form-control" name="projectName" required="" placeholder="请输入项目名称" aria-required="true">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">建设地点：</label>
                                            <div class="col-sm-3">
                                                <input id="location" value="${ingenuityWorks.location}" type="text" class="form-control" name="location" required="" placeholder="请输入建设地点" aria-required="true"><span class="help-block m-b-none">长度不应超过30个字符</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">竣工时间：</label>
                                            <div class="col-sm-3">
                                                <input id="completionTime" value="${ingenuityWorks.completionTime}" type="text" class="form-control" name="completionTime" required="" placeholder="请输入竣工时间" aria-required="true"><span class="help-block m-b-none">竣工时间请按此格式填写, 如: 2019-11 或 2019-07</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">工程造价：</label>
                                            <div class="col-sm-3">
                                                <input id="engineeringCost"  value="${ingenuityWorks.engineeringCost}"  type="text" class="form-control" name="engineeringCost" required="" placeholder="请输入工程造价" aria-required="true"><span class="help-block m-b-none">项目造价请按此格式填写，如:2000万元</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9" >
                                                ...
                                                <textarea id="projectDescription"  name="projectDescription" class="form-control" >${ingenuityWorks.projectDescription}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="radio i-checks">
                                                    <label>
                                                        <input type="radio"
                                                                <#if ingenuityWorks.type=="1">
                                                                       checked=""
                                                                </#if>
                                                               value="1" name="type"> <i></i>酒店/办公</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if ingenuityWorks.type=="2">
                                                                       checked=""
                                                                </#if>
                                                               value="2" name="type"> <i></i>学校/医院</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if ingenuityWorks.type=="3">
                                                                       checked=""
                                                                </#if>
                                                               value="3" name="type"> <i></i>商贸/住宅</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if ingenuityWorks.type=="4">
                                                                       checked=""
                                                                </#if>
                                                               value="4" name="type"> <i></i>展览/展示</label>
                                                    <label>
                                                        <input type="radio"
                                                                <#if ingenuityWorks.type=="5">
                                                                       checked=""
                                                                </#if>
                                                               value="5" name="type"> <i></i>幕墙/机电</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="layui-tab-item">
                                    <div class="layui-tab-item layui-show">
                                        <div class="ibox-content">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">图片(800px*600px)：</label>
                                                <div class="col-sm-9" >
                                                    <div id="uploader-demo" >
                                                        <#list album as item>
                                                        <input id="photoId_${item.id}"  type="hidden" name="photo" value="${item.img}"/>
                                                        </#list>
                                                        <!--用来存放item-->
                                                        <div id="fileList" class="uploader-list">
                                                        <#list album as item>
                                                            <div  id="${item.id}" class="file-item thumbnail">
                                                            <img width="150px" height="150px" src="${item.img}" />
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                                <input type="hidden" name="id" value=" ${ingenuityWorks.id}"/>
                                <button class="btn btn-primary" type="submit">提交</button>
                                <a  class="btn btn-danger" type="button"  href="${basePath}/ingenuity/works/list"><i class="fa fa-close"></i> 返回</a>
                            </div>
                        </div>
                ...
                success: function(data) { // data 保存提交后返回的数据，一般为 json 数据
                    ...
                    if(data.status == 200){
                        ...
                        layer.msg(data.message,{icon: 6,time:2000,shade: 0.1},function(index){
                            window.location.href="${basePath}/ingenuity/works/list";
                        });
                    }else{
