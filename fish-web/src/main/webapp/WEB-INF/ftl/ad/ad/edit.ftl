                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="myForm" action="${basePath}/ad/ad/edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="seq" type="text" value="${item.sort}"  class="form-control" name="sort" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="radio i-checks">
                                    <label>
                                        ...
                                        <#if item.adType=="1">
                                               ...
                                               value="1" name="adType"> <i></i>首页轮播</label>
                                    <label>
                                        <input type="radio"
                                        <#if item.adType=="2">
                                               checked="checked"
                                        </#if>
                                               value="2" name="adType"> <i></i>首页中间广告位</label>
                                    <label>
                                        <input type="radio"
                                        <#if item.adType=="3">
                                               checked="checked"
                                        </#if>
                                               value="3" name="adType"> <i></i>首页中间广告位大</label>
                                    <label>
                                        <input type="radio"
                                        <#if item.adType=="4">
                                               checked="checked"
                                        </#if>
                                               value="4" name="adType"> <i></i>商品分类广告位</label>
                                </div>
                                    ...
                                    <label>
                                        ...
                                        <#if item.type=="0">
                                               checked=checked
                                                ...
                                                value="0" name="type"> <i></i>不跳转</label>
                                    <label>
                                        <input type="radio"
                                        ...
                                        <#if item.type=="1">
                                               ...
                                               value="1" name="type"> <i></i>商家</label>
                                    <label>
                                        <input type="radio"
                                        <#if item.type=="2">
                                               checked=checked
                                        </#if>
                                               value="2" name="type"> <i></i>商品</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="linkId" type="text" value="${item.linkId}" class="form-control" name="linkId" required="" aria-required="true">商家：请输入商家ID号,商品请输入商品ID号
                            </div>
                        </div>
