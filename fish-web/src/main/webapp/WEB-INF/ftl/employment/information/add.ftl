...
<form class="form-horizontal m-t" id="myForm" action="${basePath}/employment/information/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ibox-title">
                        <div class="builder-tabs builder-form-tabs">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="${basePath}/employment/information/add">创建</a></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input id="projectAddress" type="text" class="form-control" name="projectAddress" required="" placeholder="请输入项目地址" aria-required="true"><span class="help-block m-b-none">长度不应超过30个字符</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">所需工种：</label>
                                            <div class="col-sm-3">
                                                <input id="jobDemand" type="text" class="form-control" name="jobDemand" required="" placeholder="请输入所需工种" aria-required="true"><span class="help-block m-b-none">请按此格式填写, 如: 瓦工</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">所需人数：</label>
                                            <div class="col-sm-3">
                                                <input id="number" type="text" class="form-control" name="number" required="" placeholder="请输入所需人数" aria-required="true"><span class="help-block m-b-none">留空为0</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">联系人：</label>
                                            <div class="col-sm-3">
                                                <input id="contacts" type="text" class="form-control" name="contacts" required="" placeholder="请输入联系人姓名" aria-required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">联系人电话：</label>
                                            <div class="col-sm-3">
                                                <input id="contactNumber" type="text" class="form-control" name="contactNumber" required="" placeholder="请输入联系人电话" aria-required="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
