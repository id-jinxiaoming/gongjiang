        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/employment/information/list">用工信息列表</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form id="myForm" name="admin_list_sea" class="form-search" method="post" action="${basePath}/employment/information/list">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="employment:information:add">
                    <button type="button" class="btn btn-outline btn-primary" onclick="add()">创建</button>
				</@shiro.hasPermission>
				<@shiro.hasPermission name="employment:information:delete">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <th style="text-align:center;">项目所在省</th>
                        <th style="text-align:center;">项目地址</th>
                        <th style="text-align:center;">需求工种</th>
                        <th style="text-align:center;">需求人数</th>
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].number}}</td>
                                <td>{{d[i].contacts}}</td>
                                <td>{{d[i].contactNumber}}</td>
                                <td>{{d[i].createTime}}</td>
                                <td>
								<@shiro.hasPermission name="employment:information:edit">
                                    <a href="${basePath}/employment/information/edit/{{d[i].id}}"  class="btn btn-primary  btn-xs">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/employment/information/list",
    ...
    function add(){
        window.location.href="${basePath}/employment/information/add";

    }
    function edit(id){
        window.location.href="${basePath}/employment/information/edit/"+id;
    }
    //删除所有记录
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/employment/information/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
