	...
	<h2 class="page-header">66 New Icons in 4.4</h2>
		...
		<h2 class="page-header">Web Application Icons</h2>
		 <ul class="the-icons">
		   ...
		   <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usered"></i> usered</li>
		   <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usered-plus"></i> usered-plus</li>
		   <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usered-secret"></i> usered-secret</li>
		   <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usered-times"></i> usered-times</li>
	   ...
	   <ul class="the-icons">
		...
		<h2 class="page-header">Medical Icons</h2>
		   ...
		   <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usered-md"></i> usered-md</li>
		   <li class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wheelchair"></i> wheelchair</li>
		</ul>
	<br/><br/>
</div>
