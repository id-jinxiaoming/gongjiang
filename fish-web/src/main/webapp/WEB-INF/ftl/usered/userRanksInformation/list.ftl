    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/usered/userRanksInformation/list/${userId}">队伍信息列表</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="usered:userExperience:delete">
                    <button type="button" class="btn btn-outline btn-primary" onclick="DelAll()">批量删除</button>
                </@shiro.hasPermission>
                    <a href="${basePath}/usered/usered/list" style="float: right;"  class="btn btn-white">返回</a>
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                <@shiro.hasPermission name="usered:userRanksInformation:check">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/usered/userRanksInformation/list",
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/usered/userRanksInformation/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
    ...
    function check(id){
        ...
        indexWin = layer.open({
            ...
            area: ['500px', '350px'],
            title:"审核",
            content:"${basePath}/usered/userRanksInformation/check/"+id
