    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/usered/userLabel/list/${userId}">工长标签</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="usered:userLabel:delete">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/usered/userLabel/list",
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/usered/userLabel/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
