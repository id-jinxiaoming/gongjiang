        ...
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/usered/userExperience/list/${userId}">工作经历</a></li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/usered/userExperience/list",
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/usered/userExperience/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
