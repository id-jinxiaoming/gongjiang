    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/usered/userWorkType/list/${userId}">团队工种</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="usered:userWorkType:delete">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/usered/userWorkType/list",
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/usered/userWorkType/delete",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
