    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="builder-tabs builder-form-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="${basePath}/craftsman/achievement/listed/${craftsmanAchievementId}">业绩图片</a></li>
                </ul>
            </div>
        </div>
        <div class="ibox-content" style="border-color: transparent">
            ...
            <div class="example-wrap">
                <div class="example">
				<@shiro.hasPermission name="craftsman:achievement:remove">
                    <button type="button" class="btn btn-outline btn-primary" onclick="DelAll()">批量删除</button>
                </@shiro.hasPermission>
                    <a href="${basePath}/craftsman/achievement/list" style="float: right;"  class="btn btn-white">返回</a>
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="datalist" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].id}}</td>
                                <td>
                                    <a href="javascript:;"  onclick="openImg('{{d[i].img}}')">
                                        <img src="{{d[i].img}}" style="width:80px;height:80px" onerror="this.src='${basePath}/static/webupload/empty_mid.png'"/>
                                    </a>
                                </td>
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        ...
        $.ajax({
            url: "${basePath}/craftsman/achievement/listed",
    ...
    function DelAll(){
        ...
        layer.confirm('确认删除吗?', {icon: 3, title:'提示'}, function(index){
            ...
            $.ajax({
                url: "${basePath}/craftsman/achievement/remove",
                data:"id="+checkArray,
                type: "POST",
                dataType:'json',
