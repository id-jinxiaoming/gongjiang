...
import com.ff.common.util.QiNiuUtils;
...
public class QRCodeUtil {
    ...
    //content二维码内容、imgPath插入图片的路径、destPath生成图片以后的保存位置、needCompress图片是否压缩
    ...
    public static String encode(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        String url = QiNiuUtils.uplodPicture(is);
        return url;
    }
